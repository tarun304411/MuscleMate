    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="container footer-grid">
          <div>
            <div className="footer-brand">Muscle<span>Mate</span></div>
            <p className="footer-sub">Premium Gym Supplements, Apparel & Accessories</p>
          ...
          <nav>
            ...
            <ul>
              ...
              <li><a href="/">BCAA & Aminos</a></li>
            </ul>
          </nav>
          <nav>
            <div className="footer-title">Categories</div>
            <ul>
              <li><a href="/">Belts & Straps</a></li>
          ...
          <div>
            ...
            <p className="footer-note">Get exclusive offers, new product drops and expert training tips.</p>
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="footer-bottom-content">
            <div>© {new Date().getFullYear()} MuscleMate · All rights reserved.</div>
